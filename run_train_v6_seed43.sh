#!/bin/bash
# run_train_v6_seed43.sh — Multi-seed Gate 1C, seed 43 of v6 recipe.
#
# Identical recipe to run_train_v6.sh except --seed 43 and a new outdir.
# Run on GPU 0 in the background while Gate 1A (MT baseline) is developed
# on GPU 1.
#
# Usage:
#   CUDA_VISIBLE_DEVICES=0 nohup bash run_train_v6_seed43.sh \
#       > /tmp/v6_seed43.out 2>&1 &
...
OUTDIR="$ROOT/mixed_pilot_v6_seed43"
...
echo "================================================================"
echo "  RFT-LM v6 — Multi-seed Gate 1C, SEED 43"
echo "================================================================"
...
python "$SCRIPT_DIR/train_overnight.py" \
    ...
    --seed 43 \
    --n_gpus 1 \
    2>&1 | tee "$OUTDIR/rft_lm/v6_seed43_train.log"

echo ""
echo "================================================================"
echo "  v6 seed 43 training complete"
