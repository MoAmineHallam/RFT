...
def train_rft_lm(
    ...
    if use_niah:
        ...
        # Load distractor tokens (C4 jsonl or Paul Graham essays json)
...
def main():
    ...
    ap.add_argument("--niah_distractor_path", type=str, default=None,
    ...
    ap.add_argument("--niah_value_type", type=str, default="digit2",
                    choices=["digit2", "short_int", "numbers", "uuids"],
                    help="Value type for NIAH needles. 'numbers'=7-digit (RULER standard).")
    # Training config
